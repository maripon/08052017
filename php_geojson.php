...
<?php
$json = file_get_contents('https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_hour.geojson');
...
<p>Ahora veamos los temblores más importantes registrados alrededor del mundo sobre 4.5 en la ultima hora:</p>
